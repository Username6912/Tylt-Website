...
const currentFrame = index => (
  `./images/Thinker/${index.toString().padStart(4, '0')}.webp`
)
...
canvas.width=window.innerWidth>767?1920:1500;
canvas.height=window.innerWidth>767?1080:844;
img.onload=function(){
  context.drawImage(img, 0, 100,canvas.width,canvas.height);
}
...
const x=window.innerHeight>767?150:100;
  index<x?img.src=currentFrame(1):img.src = currentFrame(index-x-1);
  context.drawImage(img, 0, 100,canvas.width,canvas.height);
}
